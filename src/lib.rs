...
fn improved_slide_match_internal(
    ...
    // 模板匹配
    let result = imageproc::template_matching::find_extremes(
        &imageproc::template_matching::match_template(
            &background_edges,
            &target_edges,
            imageproc::template_matching::MatchTemplateMethod::CrossCorrelationNormalized,
        ),
    ...
    if !validate_match_result(result.max_value, confidence_threshold) {
        ...
        let fallback_result = imageproc::template_matching::find_extremes(
            &imageproc::template_matching::match_template(
                &background_edges,
                &target_edges,
                imageproc::template_matching::MatchTemplateMethod::CrossCorrelationNormalized,
